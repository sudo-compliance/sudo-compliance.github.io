...
const PROFILE = {
  ...
  projects: [
    ...
    {
      title: "GRC Maturity Assessment Tool",
      description: "A browser-based maturity assessment across 10 GRC domains and 40 questions, aligned to ISO/IEC 27001:2022 Annex A with DORA and UK FCA/PRA touchpoints. Produces scored output, a radar chart and prioritised recommendations.",
      tags: ["GRC", "ISO 27001", "DORA", "Self-Assessment"],
      link: "https://github.com/sudo-compliance/grc-lab/tree/main/topics/grc-maturity-assessment-tool",
      featured: true,
    },
    {
      title: "Incident Classification & Escalation Framework",
      description: "A structured incident classification, escalation and regulatory notification framework for financial services under DORA, FCA and PRA requirements.",
      tags: ["DORA", "FCA/PRA", "Incident Response", "Financial Services"],
      link: "https://github.com/sudo-compliance/grc-lab/tree/main/topics/incident-classification-escalation-framework",
      featured: false,
    },
  ],
